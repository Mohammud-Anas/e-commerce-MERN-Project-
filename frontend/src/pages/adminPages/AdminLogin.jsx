...
import { loginSeller } from "../../api/seller.api.js";
...
const AdminLogin = () => {
  ...
  const onSubmit = async (data) => {
    console.log(data);
    const resposne = await loginSeller(data);
    console.log(resposne);
    if (resposne.data.success == false) {
      setModalData({ ...modalData, content: resposne.data.message });
      document.getElementById("my_modal_5").showModal();
    } else {
      const user = resposne.data.data.user;
      dispatch(sellerlogin());
      dispatch(setSellerProfile(user));
          ...
          <div class="flex justify-center items-center mt-6">
            ...
            >
              ...
              <span class="ml-2">
                ...
                <NavLink
                  to={"/signup"}
                  className=" text-blue-600 hover:text-slate-400 font-semibold"
                >
                  {" "}
                  SignUp
                </NavLink>
